...
small_font = cwd+"/fonts/AbyssinicaSIL-10.bdf"
medium_font = cwd+"/fonts/AbyssinicaSIL-10.bdf"
large_font = cwd+"/fonts/AbyssinicaSIL-12.bdf"
...
class OpenWeather_Graphics(displayio.Group):
    def __init__(self, root_group, *, am_pm=True, celsius=True):
        ...
        self.set_icon(cwd+"/weather_background160.bmp")
        ...
        self.description_text.x = 60
        self.description_text.y = 120
